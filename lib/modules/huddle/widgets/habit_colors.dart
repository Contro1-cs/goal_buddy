...
List<Color> habitsColor = [
  ...
  const Color(0XFFFF37A6),
  const Color(0XFF3D7068),
...
List<Color> habitTickColor = [
  ...
  const Color(0XFF30091F),
  const Color(0XFF68C0B2),
  const Color(0XFF3F0049),
  const Color(0XFF392E34),
  const Color(0XFF243B17),
  const Color(0XFFB2D0F9),
  const Color(0XFF00514E),
];
